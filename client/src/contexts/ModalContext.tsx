            ...
            <AnimatePresence>
                {modalOpen && (
                    <motion.div
                        ...
                        className="fixed top-0 left-0 z-[250] flex h-full w-full justify-center gap-2 bg-gradient-to-b from-transparent dark:to-white/15  to-black/20  backdrop-blur-[1px] lg:px-3 lg:py-5"
                    >
                        {content}
                        <span
