    ...
    return (
        <>
            <div className="relative min-h-screen max-lg:overflow-hidden lg:py-15">
                ...
                <div className="relative z-100 mx-auto w-full max-w-[490px] items-center space-y-1 overflow-hidden bg-white p-3 pt-7 pb-30 ring-[5px] ring-white max-lg:h-full max-lg:min-h-screen lg:rounded-3xl lg:p-7 dark:bg-zinc-900 dark:ring-zinc-900">
