...
export const AuthPageTemplate = ({
    ...
    return (
        <>
            <div className="relative min-h-screen max-lg:overflow-hidden lg:pt-15">
                ...
                <div className="relative z-100 mx-auto w-full max-w-[500px] items-center space-y-1 overflow-hidden bg-white p-3 py-7 ring-[5px] ring-white max-lg:h-full max-lg:min-h-screen lg:rounded-3xl lg:p-7 lg:px-9 dark:bg-zinc-900 dark:ring-zinc-900">
