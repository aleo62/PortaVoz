        ...
        <AnimatePresence onExitComplete={resetScrollLock}>
            {isOpen && (
                ...
                >
                    ...
                    >
                        <div className="text-title flex items-center px-5">
                            <IconSearch width={15} />
                            <input
                                type="text"
                        ...
                        <div className="flex h-40 items-center justify-center border-y-1 border-zinc-200 p-5 dark:border-zinc-700">
