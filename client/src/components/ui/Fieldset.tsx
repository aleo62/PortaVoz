...
export const Fieldset = ({ children, title, Icon, ok }: FieldsetProps) => {
    return (
        <div className="overflow-hidden rounded-2xl ring-1 ring-zinc-200 dark:ring-zinc-800">
            <header className="font-title text-subtitle flex items-center justify-between border-b-1 border-zinc-200 p-3 text-lg lg:px-5 lg:text-2xl dark:border-zinc-800 ">
