...
export const Witnes = ({ image, title, client, role }: WitnesProps) => {
    return (
        <div className="hover:bg-accent group transition-[background-color, scale] relative grid w-fit gap-15 rounded-lg bg-white/70 dark:bg-zinc-900 px-9 py-15 shadow-[0px_4px_67px_-16px_rgba(0,_0,_0,_0.1)] backdrop-blur-2xl duration-300 hover:scale-102">
            {/* main */}
