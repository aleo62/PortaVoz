...
type UpdateReportStatusModalProps = ModalDefaultProps & {
    report: ReportData;
};

export const UpdateReportStatusModal = ({ report, zIndex }: UpdateReportStatusModalProps) => {
    const { closeModal } = useModal();
    const [selectedStatus, setSelectedStatus] = useState<ReportData["status"]>(report.status);
