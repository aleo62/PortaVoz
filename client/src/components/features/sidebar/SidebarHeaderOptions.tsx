    ...
    return (
        <div className="ml-auto flex items-center gap-2 lg:gap-3">
            ...
            <button
                ...
                className="bg-accent shadow-accent/20 flex h-11 w-11 items-center justify-center rounded-full text-sm text-white shadow-md transition-all duration-300 hover:scale-102 lg:w-fit lg:px-8"
            >
