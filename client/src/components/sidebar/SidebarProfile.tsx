...
export const SidebarProfile = ({
    ...
    return (
        <nav className="scrollbar-thin sticky z-10 top-0 rounded-xl ring-1 ring-zinc-200 dark:ring-zinc-800 scrollbar-thumb-zinc-300 scrollbar-track-transparent h-fit w-full overflow-x-auto bg-white p-2 lg:w-full lg:max-w-60 dark:bg-zinc-900">
            <ul
