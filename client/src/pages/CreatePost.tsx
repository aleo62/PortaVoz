                ...
                <fieldset className="flex flex-col gap-3">
                    ...
                    <div className="flex items-center justify-center gap-1.5">
                        ...
                        {[1, 2, 3]
                            ...
                            .map(() => (
                                <div className="border-accent h-20 w-20 rounded-xl border-[2px] border-dashed bg-transparent"></div>
                            ))}
                    </div>
                </fieldset>

                <FormInput label="Título" inputProps={{ placeholder: "Buraco em minha rua" }} />
                <FormInput
                    label="Descrição"
                    textArea
